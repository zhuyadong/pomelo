...
export class FilterService {
  ...
  beforeFilter(msg: any, session: FrontendSession|BackendSession, cb: Function) {
    let index = 0;
  ...
  afterFilter(err: any, msg: any, session: FrontendSession|BackendSession, resp: any, cb: Function) {
    let index = 0;
    let next = (err: any) => {
      //if done
